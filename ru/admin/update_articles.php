...
*Приходят значения title,meta_d,meta_k,data,description,text,author, id методом  post из файла  edit_articles.php
*Присвоение этих значений из массива $_POST одноименным переменным  
*Изменение в базе в таблице articles статей
***************************************************************/
include ("lock.php");
...
$result = mysql_query ("UPDATE articles SET title='$title',meta_d='$meta_d',meta_k='$meta_k',data='$data',description='$description',text='$text',author='author' WHERE id='$id'");
