...
*в этом файле создается форма для добавление новой статьи
*Методом post значения title,meta_d,meta_k,data,description,text,author передаются в файл add_articles.php для *обработки
***************************************************************/
include ("lock.php"); 
?>
...
<?php include("bloks/lefttd.php"); ?>
        ...
        <td valign="top" id="telo">
         <h3 align="center">Добавление  статьи</h3>
        <form id="form1" name="form1" method="post" action="add_articles.php">
          <p>
