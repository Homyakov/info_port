...
*Переменные title,meta_d,meta_k,data,description,text,author приходят из файла new_lesson.php методом post 
*присваиваем значения из глобального массива $_POST одноименным переменным
*призводится встака урока в базу данных в таблицу lessons
***************************************************************/
include ("lock.php");
...
$result = mysql_query ("INSERT INTO lessons (title,meta_d,meta_k,description,data,text,author) VALUES ('$title','$meta_d','$meta_k','$description','$data','$text','$author')");
...
{
echo "<p>Не все поля заполнены,урок в базу не может быть добавлен</p>";
}				 
