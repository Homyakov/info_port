...
*полылается методом post в файл update_lesson.php значения title,meta_d,meta_k,data,description,text,author и *скрыто параметр id
***************************************************************/ 
include ("lock.php");
