...
* подключаем блоки: 
*1- с индентификацией к паролю (lock.php)
*2- шапка сайта (header.php)
*3- левого блока (lefttd.php)
*4- нижнего графического блока (footer.php)
*5- база данных (bd.php)
*6- правого блока(righttd.php)
***************************************************************/
...
<link href="style.css" rel="stylesheet" type="text/css" />
  ...
  <body>
  <table width="870" border="0" align="center" class="main_border" cellpadding="0" cellspacing="0">
    <!--Подключение шапки -->
    ...
    <tr>
      <td><table width="690" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td id="telo"><?php echo $myrow['text']; ?></td>
          </tr>
      </table></td>
      <!--Подключение правого блока-->
